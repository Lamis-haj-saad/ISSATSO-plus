...
$sql_select_single = "SELECT * FROM etudiant WHERE id = '$id'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_update = "UPDATE etudiant SET cin='$cin', nom='$nom', prenom='$prenom', login='$login', password='$password' WHERE id='$id'";

    if ($conn->query($sql_update) === TRUE) {
        echo '<script>alert("Etudiant modifié avec succès : '.$nom.'"); window.location.href = "etudiant.php";</script>';
    } else {
        echo "Erreur lors de la modification de l'etudiant : " . $conn->error;
    }
}
